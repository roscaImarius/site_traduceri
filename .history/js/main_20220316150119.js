...
--------------------------------------------- */
      ...
      if ($(window).scrollTop() >= 100) {
        $("section").each(function (i) {
          if ($(this).position().top <= $(window).scrollTop() - 0) {
            ...
            $(".nav1 .nav-item").eq(i).addClass("active1");
          }
        });
      } else {
        $(".nav1 .nav-item.active1").removeClass("active1");
      ...
      if ($(window).scrollTop() >= 100) {
        $("section").each(function (i) {
          if ($(this).position().top > $(window).scrollTop()) {
            ...
            $(".nav-link2").eq(i).addClass("active2");
          }
        });
      } else {
        $(".nav-link2.active2").removeClass("active2");
  ...
  $(".menu_nav .nav-item .nav-link, .nav-menu li a").on(
    "click",
    function (event) {
      if (this.hash !== "") {
        event.preventDefault();
